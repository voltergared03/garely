...
import {
  ...
  Calendar, User, CheckSquare, Star, Banknote, Percent, Link2, AtSign, Phone, Paperclip, Maximize2, KeyRound, Link,
} from 'lucide-react';
...
const TYPE_ICONS: Record<FieldType, ElementType> = {
  ...
  url: Link2, email: AtSign, phone: Phone, file: Paperclip, totp: KeyRound, link: Link,
};
